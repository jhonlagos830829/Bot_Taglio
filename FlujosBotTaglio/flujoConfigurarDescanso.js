...
module.exports = flujoConfigurarDescanso = addKeyword(['Descanso'])
    .addAction(async (ctx, ctxFn) => {
        ...
        try {
            ...
            await conversacion.Guardar('Latin Barber', idConversacion, nombreCliente, telefonoCliente, 'El flujo flujoConfigurarDescanso se disparó por el texto: ', ctx.body)
            ...
            */
            ...
            console.log('Error al registrar la conversación en el flujo flujoConfigurarDescanso, el sistema respondió: ' + error)
